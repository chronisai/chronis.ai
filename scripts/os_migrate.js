 ...
 */
 ...
 DO $$ BEGIN CREATE TYPE post_status   AS ENUM ('draft','in_review','published');       EXCEPTION WHEN duplicate_object THEN NULL; END $$;
 ...
 CREATE INDEX IF NOT EXISTS idx_os_posts_status      ON posts(status);
 CREATE INDEX IF NOT EXISTS idx_os_posts_category    ON posts(category);
 CREATE INDEX IF NOT EXISTS idx_os_posts_author      ON posts(author_id);
 CREATE INDEX IF NOT EXISTS idx_os_posts_published   ON posts(published_at DESC);
 CREATE INDEX IF NOT EXISTS idx_os_revisions_post    ON post_revisions(post_id);
 `;
